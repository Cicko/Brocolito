...
var game = new Phaser.Game(window.innerWidth, window.innerHeight * 0.85, Phaser.CANVAS, 'phaser-example', { preload: preload, create: create, update: update, render: render });
